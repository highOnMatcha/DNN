...
translation training, including model architecture parameters, training
hyperparameters, and dataset configuration. It supports both JSON-based
external configuration and programmatic configuration through dataclasses.
"""
...
def get_models_root_dir() -> str:
    ...
    # Go up to pokemon_sprites directory: pokemon_sprites/src/config ->
    # pokemon_sprites/src -> pokemon_sprites
...
def get_data_root_dir() -> str:
    ...
    Returns:
        ...
        Can be overridden with POKEMON_DATA_ROOT environment variable for
        testing.
    """
...
def get_training_config(config_type: str = "development") -> TrainingConfig:
    ...
    Args:
        config_type: Type of training configuration ("test", "development",
                     "production").
...
def list_available_models() -> Dict[str, List[str]]:
    ...
    Returns:
        Dictionary mapping architecture names to lists of available model
        names.
    """
    configs = load_model_configs()
    result = {}
...
def create_experiment_config(
    model_name: str, config_type: str = "development"
