...
class TestBasicConfiguration(unittest.TestCase):
    ...
    def test_training_config_creation(self):
        ...
        print_test_result("TrainingConfig creation", True, 
                         f"epochs: {config.epochs}, batch_size: {config.batch_size}")

    def test_model_config_creation(self):
        """Test ModelConfig instantiation."""
        config = ModelConfig(name="test", architecture="pix2pix", output_dir="/tmp/test")
        ...
        print_test_result("ModelConfig creation", True, 
    ...
    def test_get_training_config(self):
        ...
        print_test_result("Training config retrieval", True, 
                         f"Config type: development")
    ...
    def test_list_available_models(self):
        ...
        print_test_result("Available models list", True, 
    ...
    def test_get_available_training_configs(self):
        ...
        print_test_result("Available training configs", True, 
                         f"Configs: {configs}")


if __name__ == '__main__':
    print(f"{TestColors.BLUE}{TestColors.BOLD}Running Simple Configuration Tests{TestColors.RESET}\n")
